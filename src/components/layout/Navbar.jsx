  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-secondary-500 transform transition-transform group-hover:scale-110 group-hover:-rotate-12 select-none">
            T
          </span>
          <span className="bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent transition-all duration-300 group-hover:tracking-wider select-none">
            harun
          </span>
        </button>
      ...
      >
        <div className="flex flex-col h-full px-8 py-10">
          ...
          <div className="mt-auto py-8 border-t border-gray-200 dark:border-white/10">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 uppercase tracking-widest font-bold">
              Social Connection
            </p>
